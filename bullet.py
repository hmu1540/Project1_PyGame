...
class Bullet(Sprite):
    ...
    def update(self):
        ...
        # Update the decimal position of the bullet by decreasing y-coordinate value. no need to change x-coord value. bullets travel vertically in a straight line.
